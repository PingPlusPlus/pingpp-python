...
try:
    charge = pingpp.Charge.create(
        ...
        app=dict(id=app_id),
        channel='cb_wx_pub_qr',  # https://www.pingxx.com/api#支付渠道属性值
        currency='cny',
        client_ip='127.0.0.1',  # 发起支付请求客户端的 IP 地址，格式为 IPV4，如: 127.0.0.1
        subject='Your Subject',
        body='Your Body',
        extra=dict(
            # 必须，商品 ID，1-32 位字符串。此 id 为二维码中包含的商品 ID，商户自行维护
            product_id='12345678',
            # 可选,只能填写此值 "no_credit"
            limit_pay='no_credit',
            # 商品列表 上送格式为:  [{"goods_name":"iPhone6s 16G","goods_num":"1"},{"goods_name":"iPhone6s 32G","goods_num":"1"}]
