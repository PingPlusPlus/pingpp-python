...
try:
    ...
    charge = pingpp.Charge.create(
        ...
        channel='isv_wap',  # https://www.pingxx.com/api#支付渠道属性值
        currency='cny',
        client_ip='127.0.0.1',  # 发起支付请求客户端的 IP 地址，格式为 IPV4，如: 127.0.0.1
        subject='Your Subject',
        body='Your Body',
        extra=dict(
            pay_channel='alipay',  # 必须，支付具体渠道，目前支持：alipay、wx。
            result_url='https://www.example.com/payment-result',  # 必须，前台通知地址，支付成功或失败后，需要跳转到的地址URL。
            terminal_id='00000001',  # 必须，终端号，如没有终端概念，可使用00000001。
            # 可选，商品列表，上送格式参照下面示例。
