...
print "获取Red envelope对象列表:"
try:
    red_envelope_list = pingpp.RedEnvelope.all()
    print(red_envelope_list)
except Exception as e:
    print e.http_body

print "获取Red envelope对象:"
try:
    red_envelope_info = pingpp.RedEnvelope.retrieve('red_mDmLS89C4u9KCKSyzHGCOO0C')
    print red_envelope_info
except Exception as e:
    print e.http_body
